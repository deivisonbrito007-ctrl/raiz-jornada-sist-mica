...
export function HeroRaiz() {
  return (
    <section className="relative isolate overflow-hidden bg-floresta text-floresta-foreground">
      ...
      <div className="mx-auto max-w-5xl px-6 pb-36 pt-32 md:pb-44 md:pt-40">
        <div className="flex flex-col items-center text-center md:items-start md:text-left">
          <RaizLogo className="h-20 w-auto md:h-24" />

          <p className="mt-10 inline-flex items-center gap-2 rounded-full border border-ocre/35 bg-floresta/40 px-4 py-2 text-[0.68rem] font-medium uppercase tracking-[0.24em] text-ocre">
            <Sprout className="h-3.5 w-3.5" aria-hidden="true" />
            constelação familiar
          </p>

          <h1 className="mt-8 max-w-2xl text-[2rem] font-normal leading-[1.22] tracking-[-0.005em] text-floresta-foreground md:text-[3.4rem] md:leading-[1.14]">
            O trabalho continua
            <br />
            entre as sessões.
          </h1>

          <p className="mt-7 max-w-md text-[1.02rem] leading-[1.75] text-floresta-foreground/80 md:max-w-lg md:text-lg md:leading-[1.7]">
          ...
          <div className="mt-12 flex w-full flex-col gap-3.5 sm:w-auto sm:flex-row sm:items-center">
            <Link
              to="/auth"
