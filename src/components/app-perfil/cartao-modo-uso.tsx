  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span className="rounded-2xl bg-salvia/15 p-3 text-salvia">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm font-medium text-floresta">{texto.titulo}</p>
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">{texto.descricao}</p>
          {modoDesde && (
          ...
          {texto.acao === "pedir-apoio" && (
            <Link
              to="/app/jornada"
              className="mt-4 inline-flex min-h-11 items-center rounded-full bg-terracota px-5 text-sm text-terracota-foreground"
            >
              {texto.rotuloAcao}
            </Link>
          )}
          {texto.acao === "pedir-acompanhamento" && (
            <Link
              to="/app"
              className="mt-4 inline-flex min-h-11 items-center rounded-full border border-border bg-secondary px-5 text-sm text-floresta"
            >
              {texto.rotuloAcao}
            </Link>
          )}
